                    ...
                    <form action="{{ route('stocks.update', $stock->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-full">
                                ...
                                <input type="text" name="item" id="item" value="{{ old('item', $stock->item) }}" 
                            ...
                            <div>
                                ...
                                <select name="categoria" id="categoria" 
                                    class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm" required>
                                    @php $cats = ['Tecidos', 'Aviamentos', 'Linhas', 'Embalagens', 'Outros']; @endphp
                                    @foreach($cats as $cat)
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="number" name="quantidade" id="quantidade" value="{{ old('quantidade', $stock->quantidade) }}" 
                                        class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm pl-10" min="0" required>
                            ...
                            <div class="col-span-full">
                                ...
                                <textarea name="descricao" id="descricao" rows="3" maxlength="500"
                                    ...
                                    required>{{ old('descricao', $stock->descricao) }}</textarea>
