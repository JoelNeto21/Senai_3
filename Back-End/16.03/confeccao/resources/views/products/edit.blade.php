                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-full">
                                ...
                                <input type="text" name="nome" id="nome_format" value="{{ old('nome', $product->nome) }}" 
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="text" inputmode="numeric" name="quantidade" id="quantidade" value="{{ old('quantidade', $product->quantidade) }}" 
                                        class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm pl-10" required>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    {{-- Note que aqui formatamos o valor que vem do BD para manter a máscara padrão: 1.500,00 --}}
                                    <input type="text" inputmode="numeric" name="valor" id="valor" value="{{ old('valor', number_format($product->valor, 2, ',', '.')) }}" 
                                        class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm pl-10" required>
                                </div>
