                ...
                @foreach ($products as $product)
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-200 relative overflow-hidden flex flex-col justify-between">
                        ...
                        <div class="flex justify-between items-start">
                            ...
                            <span class="text-[10px] font-bold uppercase truncate w-2/3 text-gray-400">
                        ...
                        <div class="mb-6">
                            <div class="flex justify-between items-start mb-1">
                                <h3 class="text-lg font-black text-gray-900 uppercase truncate w-2/3" title="{{ $product->nome }}">
                                    {{ $product->nome }}
                                </h3>
                            </div>
