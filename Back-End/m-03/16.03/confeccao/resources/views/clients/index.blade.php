    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @forelse ($clients as $client)
                    <div class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-200">
                        ...
                        <div class="flex items-center gap-2 mb-6">
                            ...
                            <div class="min-w-0">
                                <h3 class="text-lg font-bold text-blue-600 leading-tight">{{ $client->nome }}</h3>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            ...
                            <div class="flex items-center gap-2">
                                <a href="{{ route('clients.edit', $client->id) }}" class="p-2 bg-gray-100 hover:bg-blue-50 text-gray-600 hover:text-blue-600 rounded-lg transition-colors duration-200" title="Editar">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                                    </svg>
                                </a>

                                <button type="button" onclick="openDeleteModal('{{ route('clients.destroy', $client->id) }}', '{{ $client->nome }}')" class="p-2 bg-gray-100 hover:bg-red-50 text-gray-600 hover:text-red-600 rounded-lg transition-colors duration-200" title="Excluir">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                @empty
                    <div class="col-span-full flex flex-col items-center justify-center py-12 rounded-xl">
                        <p class="text-gray-400 font-medium">Nenhum cliente encontrado no sistema da confecção...</p>
                    </div>
                @endforelse
            </div>
        </div>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-6 sm:text-left">
                            ...
                            <div class="mt-2">
                                <p class="text-sm text-gray-500">
                                    Deseja remover o cliente <span id="clientNameText" class="font-bold text-red-600 text-base"></span>? 
...
<script>
    function openDeleteModal(url, name) {
        ...
        document.getElementById('clientNameText').innerText = name;
